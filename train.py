...
def train(config, args):
    ...
    corpus_vocab = Vocab(config,
                         min_freq=5,
                         max_size=50000)
    if config.text_encoder.type == "KoBert":
    ...
    if config.text_encoder.type == "KoBert":
        ...
        grouped_parameters = [
            {'params': [p for n, p in param if 'KoBert' in n and not any(nd in n for nd in no_decay)],
             'weight_decay': args.l2rate, 'lr': config.train.optimizer.learning_rate},
            {'params': [p for n, p in param if 'KoBert' in n and any(nd in n for nd in no_decay)],
             'weight_decay': 0.0, 'lr': config.train.optimizer.learning_rate},
            {'params': [p for n, p in param if 'KoBert' not in n and not any(nd in n for nd in no_decay)],
             'weight_decay': args.l2rate, 'lr': args.learning_rate},
            {'params': [p for n, p in param if 'KoBert' not in n and any(nd in n for nd in no_decay)],
