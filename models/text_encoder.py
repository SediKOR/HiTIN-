...
class KoBertTextEncoder(AutoModelForMaskedLM):
    def __init__(self, config):
        """
        ...
        """
        super(KoBertTextEncoder, self).__init__(config)
        self.kobert = AutoModelForMaskedLM(config)
    ...
    def forward(self, batch):
        ...
        :return:
        """
        outputs = self.kobert(batch['input_ids'], attention_mask=batch['input_mask'])
